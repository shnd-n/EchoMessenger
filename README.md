...
- 사용한 기술과 구현한 기능:
  ...
  - ListBox.Items.Add를 이용하여 ListBox에 메세지를 추가하고 TextBox.Clear를 이용하여 입력창을 비우게 구현
  - Focus를 활용하여 직접 마우스를 움직여 입력창에 다시 클릭하지 않아도 커서를 입력창에 유지시키도록 구현
  - 전송 버튼 클릭 뿐만 아니라 엔터키로도 할 수 있게 구현
  - Trim을 활용하여 필요없는 공백을 제거하여 ListBox에 추가하도록 구현
...
- 기능을 계속 추가하면서 이런 기능이 사용자의 편의에 얼마나 중요한지 알게 되었습니다.
